...
public class LayoutActivity2 extends ActionBarActivity {
	...
	class ButtonClickListener implements OnClickListener{
		public void onClick(View v){
			Intent intent;
			if (v == btn1){
				intent = new Intent(LayoutActivity2.this, MainActivity.class);			
			}else if(v == btn2){
				intent = new Intent(LayoutActivity2.this, LayoutActivity1.class);							
			}else{
				intent = null;
			}
